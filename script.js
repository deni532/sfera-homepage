/* ── Theme toggle ── */
        ...
        const solText = {
            ...
            de: {
                ...
                'lavora-con-noi':   { headline: 'Gemeinsam gestalten wir die Zukunft des Smart Home.', sub: 'SFERA ist ein junges, ehrgeiziges Startup, das einen neuen Ansatz für das intelligente Zuhause einführt. Wir suchen junge Fachleute, die für Elektronik, Elektrotechnik und Technologie begeistert sind und bereit sind, mit uns zu wachsen und die Lösungen der Zukunft zu entwickeln.', benefits: ['Innovatives Startup in starkem Wachstum', 'Kontinuierliche Weiterbildung und berufliche Entwicklung', 'Technologien, die die Zukunft des Smart Home repräsentieren'], cta: 'Bewerbung einsenden →' },
        ...
        const translations = {
            ...
            de: {
                ...
                'hero-btn1':     'Kostenlose Besichtigung buchen',
                ...
                'nav-btn-cta':            'Kostenlose Besichtigung →',
                ...
                /* ── Contatti modal ── */
                'sol-cta':        'Kostenlose Besichtigung buchen →',
                'ct-eyebrow':     'Kontakt',
                ...
                'how-1-desc':   'Wir analysieren dein Zuhause. Keine Verpflichtung.',
                'how-2-title':  'Planung',
                ...
                'nav-s-comfort-plain': 'Comfort Smart',
                'cta-btn':       'Jetzt kostenlose<br>BESICHTIGUNG BUCHEN',
                ...
                /* ── Cookie ── */
                'cookie-text':    'Wir verwenden Cookies, um das Surferlebnis zu verbessern. Mit der weiteren Nutzung akzeptierst du unsere <a href="/privacy-policy.html">Datenschutzerklärung</a>.',
                'cookie-accept':  'Alle akzeptieren',
                'cookie-decline': 'Nur notwendige',
                /* ── Exit popup ── */
                'exit-h3':  'Bevor du gehst…',
                'exit-p':   'Hast du die richtige Lösung für dein Zuhause gefunden? Einer unserer Experten antwortet dir in wenigen Stunden — kostenlos.',
                ...
                'faq-6-q':'Was passiert nach der Installation?','faq-6-a':'Wir bieten kontinuierlichen Support, Remote-Updates und Prioritäts-Support. Wir sind immer für dich da.',
                /* ── Quiz ── */
            ...
            en: {
                ...
                'ct-wa-label':    'WhatsApp',
                'ct-wa-hint':     'We usually reply within a few minutes',
                ...
                'sol-2': 'Scene «I\'m leaving»: with one tap (or automatically) all standby loads are switched off and protection activated.',
                ...
                'cs-tag-full':'Full Smart','cs-tag-comfort':'Comfort Smart','cs-tag-energy':'Energy Smart',
                'cs-1-title':'Private house, Appiano, South Tyrol','cs-1-meta':'110 m² · 4 rooms · Renovation','cs-1-result':'Lights, climate, security + integrated 3D control','cs-1-video-btn':'Watch video',
                ...
                'faq-3-q':'Does it work without internet?','faq-3-a':'Yes. Local functions — lights, climate, scenes — always work offline. Internet is only needed for remote control.',
                'faq-4-q':'How long does installation take?','faq-4-a':'A standard apartment takes 1–3 working days. Larger projects are planned in detail during the 3D design phase.',
